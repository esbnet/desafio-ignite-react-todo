...
export function TodoList() {
  return (
    <>
      <section className="mx-auto h-[287px] max-w-[736px] text-gray-300 mt-16">
        ...
        <div className="flex flex-col justify-center items-center mt-6 w-full min-w-full h-56 text-gray-300 rounded-lg border-t border-gray-400">
          <img src={Clipboard} />
